...
class ROCMDriver {
 public:
  ...
  static port::StatusOr<CUdevice> DeviceFromContext(ROCmContext* context);
  ...
  static bool CreateStream(ROCmContext* context, CUstream *stream);
  ...
  static void DestroyStream(ROCmContext* context, CUstream *stream);
  ...
  // http://docs.nvidia.com/rocm/rocm-driver-api/group__ROCM__EVENT.html#group__ROCM__EVENT_1g450687e75f3ff992fe01662a43d9d3db
  static port::Status CreateEvent(ROCmContext* context, CUevent *result,
                                  EventFlags flags);
  ...
  static port::Status DestroyEvent(ROCmContext* context, CUevent *event);
  ...
  // cuFuncGetAttribute (the underlying ROCM driver API routine) only operates
  ...
  static bool LaunchKernel(ROCmContext* context, CUfunction function,
  ...
  static bool GetModuleFunction(ROCmContext* context, CUmodule module,
  ...
  static bool GetModuleSymbol(ROCmContext* context, CUmodule module,
  ...
  static void UnloadModule(ROCmContext* context, CUmodule module);
  ...
  static bool SynchronousMemsetUint8(ROCmContext* context, CUdeviceptr location,
  ...
  static bool AsynchronousMemsetUint8(ROCmContext* context, CUdeviceptr location,
  ...
  static bool AsynchronousMemcpyD2H(ROCmContext* context, void *host_dst,
                                    CUdeviceptr gpu_src, uint64 size,
                                    CUstream stream);
  static bool AsynchronousMemcpyH2D(ROCmContext* context, CUdeviceptr gpu_dst,
                                    const void *host_src, uint64 size,
                                    CUstream stream);
  static bool AsynchronousMemcpyD2D(ROCmContext* context, CUdeviceptr gpu_dst,
                                    CUdeviceptr gpu_src, uint64 size,
                                    CUstream stream);
  ...
  // details.
  static bool AddStreamCallback(ROCmContext* context, CUstream stream,
  ...
  static bool WaitStreamOnEvent(ROCmContext* context, CUstream stream,
                                CUevent event);
  ...
  static bool SynchronizeStream(ROCmContext* context, CUstream stream);
  ...
  static bool IsStreamIdle(ROCmContext* context, CUstream stream);
  ...
  static port::Status RecordEvent(ROCmContext* context, CUevent event,
                                  CUstream stream);
  ...
  static port::StatusOr<CUresult> QueryEvent(ROCmContext* context,
                                             CUevent event);

  // -- Pointer-specific calls.

  // Returns the context in which pointer was allocated or registered.
  static port::StatusOr<ROCmContext*> GetPointerContext(CUdeviceptr pointer);
  ...
  // Returns the number of visible ROCM device via cuDeviceGetCount.
...
// ROCmContext wraps a rocm CUcontext handle, and includes a unique id. The
// unique id is positive, and ids are not repeated within the process.
class ROCmContext {
 public:
  ROCmContext(CUcontext context, int64 id) : context_(context), id_(id) { }
