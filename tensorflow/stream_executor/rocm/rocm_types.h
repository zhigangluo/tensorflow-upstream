...
hipDevice_t AsHipDevice(GPUDeviceHandle hnd) {
  return reinterpret_cast<hipDevice_t>(hnd);
}

hipDevice_t* AsHipDevicePtr(GPUDeviceHandle* hndPtr) {
  return reinterpret_cast<hipDevice_t*>(hndPtr);
}
