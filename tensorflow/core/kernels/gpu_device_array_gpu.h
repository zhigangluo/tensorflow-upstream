...
#ifndef THIRD_PARTY_TENSORFLOW_CORE_KERNELS_GPU_DEVICE_ARRAY_GPU_H_
#define THIRD_PARTY_TENSORFLOW_CORE_KERNELS_GPU_DEVICE_ARRAY_GPU_H_
...
#endif  // THIRD_PARTY_TENSORFLOW_CORE_KERNELS_GPU_DEVICE_ARRAY_GPU_H_
