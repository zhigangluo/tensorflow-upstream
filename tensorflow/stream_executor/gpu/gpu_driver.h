...
class GpuDriver {
 public:
  ...
  static bool AsynchronousMemsetUint8(GpuContext* context, GpuDevicePtr location,
  ...
  static port::StatusOr<MemorySpace> GetPointerMemorySpace(GpuDevicePtr pointer);
