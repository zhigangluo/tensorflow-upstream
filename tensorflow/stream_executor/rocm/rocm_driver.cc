...
/* static */ port::StatusOr<hipDevice_t> GpuDriver::GetPointerDevice(hipDeviceptr_t pointer) {
...
/* static */ bool GpuDriver::GetDeviceProperties(hipDeviceProp_t *device_properties,
                                                  int device_ordinal) {
